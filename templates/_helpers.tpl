...
{{ include "hello-nginx.selectorLabels" . }}
application: nginx
{{- if .Chart.AppVersion }}
...
*/}}
{{- define "hello-nginx.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "hello-nginx.fullname" .) .Values.serviceAccount.name }}
{{- else }}
